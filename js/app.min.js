      ...
      let c = document.querySelector(".wrapper"),
        b = new Swiper(".page", {
          ...
          on: {
            init(a) {
              d(), scrollProgress(a);
              let b = a.slides[a.realIndex],
                c = b.querySelectorAll("img[data-src], source[data-srcset]");
              c.forEach((a) => loadImage(a)),
                header
            ...
            slideChange(a) {
              ...
              let f = c.getAttribute("data-section");
              setTimeout(() => {
                updateCounter(b + 1, f);
              }, a.params.speed / 2);
              let e = c.querySelectorAll("img[data-src], source[data-srcset]");
              e.forEach((a) => loadImage(a));
            },
            resize() {
              d();
            },
